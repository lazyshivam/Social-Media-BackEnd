module.exports = {
    ...
    USER_STATUS_INACTIVE: 'The status of the User is inactive successful',
    USER_STATUS_ACTIVE: 'The status of the User is active successful',
    USER_NAME_ALREADY_EXISTS: 'The User name is already exists. Please use a different name',
    USER_EMAIL_ALREADY_EXISTS: 'The User email is already exists. Please use a different email',
    USER_UPDATE: 'User information has been successfully updated',
    USER_CREATE: 'User information has been successfully created',
